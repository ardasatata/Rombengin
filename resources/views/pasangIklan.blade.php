...
@section('content')
<form name="TIKLAN" enctype="multipart/form-data" id="TIKLAN" method="post" action="/pasang">

<input type="hidden" name="_token" value="{{ csrf_token() }}">
    <h1>ADD NEW ITEMS</h1>
		<label>Judul</label> : <input name="judul" type="text" id="TJUDUL" size="30" maxlength="45"><br><br>
		<label>Harga</label> : <input name="harga" type="text" id="THARGA" size="30" maxlength="30"><br><br>
		...
		<label>Deskripsi</label> : <textarea name="konten" cols="50" rows="8" id="TDESKR"></textarea><br><br>
    <div id="btn">
    <br>
